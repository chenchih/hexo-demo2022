...
> **Note:**
>> 以下我都是以**ubuntu 24.04/25.04** 為主，但如果你是用**20.04我下面會提示說明他是20.04**
...
> 請修改 genieacs檔: `vi /opt/genieacs/genieacs.env`
...
如果上面沒問題可以開啟網頁 http://127.0.0.1:3000 或 http://<本地IP>:3000 就會出現genieacs網頁，請點如圖連結來啟動她

{% asset_img activate.png %}

## CPE 註冊ACS server
每加CPE用指令位置不一樣，就類似下面這樣。
